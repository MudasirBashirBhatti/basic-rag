...
loader = PyMuPDF4LLMLoader("10th-updated-phy.pdf")
pages = loader.load()

text_splitter = RecursiveCharacterTextSplitter(chunk_size=1000, chunk_overlap=150,separators=["\n\n", "\n", ".", " ", ""]) # Initialize the text splitter with a chunk size of 1000 characters and an overlap of 150 characters between chunks
